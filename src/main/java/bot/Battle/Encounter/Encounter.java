...
class Encounter extends Battle
{
    ...
    private HostileRoster                       hostileRoster;
     ...
     */
    @Override
    protected void preJoinPhase() throws CustomException
    {
     ...
     *
     * @throws CustomException If the explorer is not slain
     *                         If there is no phoenix down to be used
     */
    private void usePhoenixDown(@NotNull EncounteredExplorer explorer) throws CustomException
    {
        if (!explorer.isSlain()) {
            throw new CustomException(String.format(
            ...
            throw new CustomException(String.format(
                "The guild leaders do not have any more phoenix down, %s cannot be revived",
                explorer.getName()
            ));
        }
