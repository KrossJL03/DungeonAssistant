...
public class Constant
{
    ...
    public static final String CREATURE_STAT_HITPOINTS           = "hitpoints";
    public static final String CREATURE_STAT_HITPOINTS_SHORT     = "hp";
    ...
    public static final int    EXPLORER_MAX_HITPOINTS            = 250;
    ...
    public static final int    HOSTILE_MAX_ATTACK                = 9999;
    public static final int    HOSTILE_MAX_HITPOINTS             = 9999999;
    public static final int    HOSTILE_MAX_VISIBLE_HITPOINTS     = 999;
