...
public class MultipleExplorersException extends RuntimeException implements CustomExceptionInterface {

    public MultipleExplorersException(Player player, String name) {
        super(
            String.format(
